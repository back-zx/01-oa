...
<center>
    ...
    <form name="form1" method="post" action="${pageContext.request.contextPath}/desktop/news/changeNewsLabel">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            <tr>
                <td style="display:none"><input name="id" value="${newsLabel.id} " type="hidden"></td>
                <td class="td_02">栏目名称</td>
                <td class="td_02"><input name="labelName" type="text" class="input" style="width:99% " value="${newsLabel.label_name}"></td>
            </tr>
            <tr>
                <td class="td_02">上级栏目名称</td>
                <td class="td_02">
                    <select name="superLabelName" style="width:99% ">
                        <option value="0" selected>${newsLabel.label_name}</option>
                        <c:forEach items="${newsLabelList}" var="newsLabels">
                            <option>${newsLabels.label_name}</option>
                        </c:forEach>
                </select>
                </td>
            </tr>
            <tr>
                ...
                <td width="86%" class="td_02">
                    <textarea name="labelContent" rows="5" style="width:99% ">${newsLabel.label_content}</textarea>
                </td>
            </tr>
        </table>
        <br>
