...
<center>
    ...
    <form name="form1" method="post" action="${pageContext.request.contextPath}/desktop/news/addNewsLabel">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                ...
                <td class="td_02">
                    <select name="superLabelName" class="input" style="width:99% ">
                         <option selected>--请选择--</option>
                         <c:forEach items="${newsLabelList}" var="newsLabel">
                           <option>${newsLabel.label_name}</option>
                         </c:forEach>
                    </select></td>
            </tr>
            <tr>
        ...
        <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_page"><div align="center">
                    <input name="Submit" type="submit" class="buttonface02" value="  添 加  " onClick="addNewsLabel()">
                    &nbsp;&nbsp;
